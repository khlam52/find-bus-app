...
import DarkUnTickIcon from '~src/assets/images/icon/dark-untick-icon.svg';
...
import GoArrowIcon from '~src/assets/images/icon/go-arrow-icon.svg';
import GoLeftArrowIcon from '~src/assets/images/icon/go-left-arrow-icon.svg';
...
import LightUnTickIcon from '~src/assets/images/icon/light-untick-icon.svg';
import SearchIcon from '~src/assets/images/icon/search-icon.svg';
import TabHeartIcon from '~src/assets/images/icon/tab-heart-icon.svg';
import TabHomeIcon from '~src/assets/images/icon/tab-home-icon.svg';
import TabSearchIcon from '~src/assets/images/icon/tab-search-icon.svg';
export {
  BackIcon,
  AppIcon,
  TabHomeIcon,
